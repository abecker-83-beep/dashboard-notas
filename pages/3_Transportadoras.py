...
from utils.business import (
    ...
    formatar_moeda_br,
    calcular_score_transportadoras,
)
...
if df_filtrado.empty:
    st.warning("Nenhum dado encontrado para a transportadora selecionada.")
    st.stop()
...
if transportadora_selecionada == "Todas":
    ...
    st.subheader(f"Tabela executiva - {transportadora_selecionada}")

ranking_tabela = ranking_score.sort_values(
